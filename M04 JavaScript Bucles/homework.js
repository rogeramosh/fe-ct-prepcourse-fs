...
function colors(color) {
   ...
   // Tu código:
   if(color === "blue") return  "This is blue"; else if(color === "red") return "This is red" ; else if(color === "green") return "This is green"
...
function fizzBuzz(num) {
   ...
   if(num%3 === 0) return "fizz";else if (num%5 === 0) return "buzz";
   else return false;
}
fizzBuzz(15)
